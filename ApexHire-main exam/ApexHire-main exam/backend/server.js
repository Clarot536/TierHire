...
import pg from 'pg'; // ✅ FIX: Import the 'pg' library for SQL judging
import dotenv from "dotenv";
import { query as queryMainDb } from "./db.js"; // ✅ FIX: Consistently use 'queryMainDb' for clarity
...
const { Pool } = pg; // ✅ FIX: Destructure Pool from the pg import
...
// GET a list of all problems for the lobby
...
// GET details for a single problem
